...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_siegel_uniffi_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_siegel_uniffi_rustbuffer_free(self, $0) }
    }
}
 ...
 */
public protocol SiegelSessionProtocol: AnyObject, Sendable {
 ...
 * runs the application operation against the loaded siegel and wipes.
 */
open class SiegelSession: SiegelSessionProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_siegel_uniffi_fn_clone_siegelsession(self.handle, $0) }
    }
    /**
     ...
     */
public convenience init(len: UInt32)throws  {
    let handle =
        try rustCallWithError(FfiConverterTypeSessionError_lift) {
        uniffiCallStatus in
    uniffi_siegel_uniffi_fn_constructor_siegelsession_new(
    ...
    deinit {
        ...
        try! rustCall { uniffi_siegel_uniffi_fn_free_siegelsession(handle, $0) }
    }
     ...
     * security guarantee. Stable for the lifetime of the session.
     */
open func handleId() -> UInt64  {
    return try!  FfiConverterUInt64.lift(try! rustCall() {
        uniffiCallStatus in
    uniffi_siegel_uniffi_fn_method_siegelsession_handle_id(
...
open func isConsumed() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
        uniffiCallStatus in
    uniffi_siegel_uniffi_fn_method_siegelsession_is_consumed(
            self.uniffiCloneHandle(),uniffiCallStatus
    )
})
}
...
open func len() -> UInt32  {
    return try!  FfiConverterUInt32.lift(try! rustCall() {
        uniffiCallStatus in
    uniffi_siegel_uniffi_fn_method_siegelsession_len(
            self.uniffiCloneHandle(),uniffiCallStatus
    )
})
}
     ...
     * Wipe the session without using it. Idempotent.
     */
open func obliviate()  {try! rustCall() {
        uniffiCallStatus in
    uniffi_siegel_uniffi_fn_method_siegelsession_obliviate(
            self.uniffiCloneHandle(),uniffiCallStatus
    )
}
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeSiegelSession: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = SiegelSession

    public static func lift(_ handle: UInt64) throws -> SiegelSession {
        return SiegelSession(unsafeFromHandle: handle)
    }

    public static func lower(_ value: SiegelSession) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SiegelSession {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: SiegelSession, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSiegelSession_lift(_ handle: UInt64) throws -> SiegelSession {
    return try FfiConverterTypeSiegelSession.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeSiegelSession_lower(_ value: SiegelSession) -> UInt64 {
    return FfiConverterTypeSiegelSession.lower(value)
}
 ...
 */
public 
enum SessionError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case TooManyActiveSessions(message: String)
    
    case AllocationFailed(message: String)
...
public struct FfiConverterTypeSessionError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SessionError {
        ...
        case 5: return .TooManyActiveSessions(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 6: return .AllocationFailed(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 7: return .ProtectionFailed(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: SessionError, into buf: inout [UInt8]) {
        ...
        case .Consumed(_ /* message is ignored*/):
            writeInt(&buf, Int32(4))
        case .TooManyActiveSessions(_ /* message is ignored*/):
            writeInt(&buf, Int32(5))
        case .AllocationFailed(_ /* message is ignored*/):
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_siegel_uniffi_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_siegel_uniffi_checksum_method_siegelsession_handle_id() != 21075) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_siegel_uniffi_checksum_method_siegelsession_is_consumed() != 50999) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_siegel_uniffi_checksum_method_siegelsession_is_locked() != 17253) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_siegel_uniffi_checksum_method_siegelsession_len() != 45300) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_siegel_uniffi_checksum_method_siegelsession_obliviate() != 61861) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_siegel_uniffi_checksum_constructor_siegelsession_new() != 60777) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureSiegelUniffiInitialized() {
